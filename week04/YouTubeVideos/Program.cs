...
class Program
{
    static void Main(string[] args)
    {
        ...
        video1.AddComment(new Comment("The is no resurrection until after the coming of Christ."));
        video1.AddComment(new Comment("There is a space between the time of death and resurrection."));
        video1.AddComment(new Comment("Wickedness never was happiness."));
        
        videos.Add(video1);
        
        Video video2 = new Video("Corinthians 12", "Resurrection of the Death | The Bible");
        ...
        Video video3 = new Video("Elder Quentin L.", "Chossing Eternal Families Over Modern-Day 'Idols'.");
        ...
        foreach (Video video in videos)
        {
            ...
            Console.WriteLine($"Length: {video.GetLenghthInSeconds()} seconds");
